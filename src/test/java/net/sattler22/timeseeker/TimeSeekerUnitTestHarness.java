...
public final class TimeSeekerUnitTestHarness {
    ...
    public void happyPathTestCase1() throws TimeFittingException {
        assertValidSolution(new int[] { 0, 0, 0, 0, 0, 1 }, "00:00:01");
    }
    ...
    public void happyPathTestCase4() throws TimeFittingException {
        assertValidSolution(new int[] { 0, 7, 0, 8, 0, 9 }, "07:08:09");
    }

    @Test
    public void happyPathTestCase5() throws TimeFittingException {
        assertValidSolution(new int[] { 1, 2, 3, 4, 5, 6 }, "12:34:56");
    }
    ...
    public void happyPathTestCase7() throws TimeFittingException {
        assertValidSolution(new int[] { 1, 6, 2, 7, 3, 8 }, "16:27:38");
    }

    @Test
    public void happyPathTestCase8() throws TimeFittingException {
        assertValidSolution(new int[] { 2, 3, 4, 4, 4, 4 }, "23:44:44");
    }
     ...
     */
    private void assertValidSolution(int[] values, String expected) throws TimeFittingException {
